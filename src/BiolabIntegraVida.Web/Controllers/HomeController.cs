...
using BiolabIntegraVida.Infrastructure;
using BiolabIntegraVida.Infrastructure.Interfaces;
using BiolabIntegraVida.InterPlayers.Services;
using BiolabIntegraVida.InterPlayers.ValueObjects;
using BiolabIntegraVida.Web.Configuration;
using BiolabIntegraVida.Web.UseCases.CadastreSeDados;
using BiolabIntegraVida.Web.ValueObjects;
using BiolabIntegraVida.Web.ViewModels.LandingPages;
